...
CREATE TABLE `detalle_ventas` (
  ...
  `cantidad` datetime DEFAULT NULL,
  PRIMARY KEY (`id_detalle`),
  KEY `fk_id_producto` (`fk_id_producto`),
  KEY `fk_id_venta` (`fk_id_venta`),
  CONSTRAINT `detalle_ventas_ibfk_1` FOREIGN KEY (`fk_id_producto`) REFERENCES `productos` (`id_producto`),
  CONSTRAINT `detalle_ventas_ibfk_2` FOREIGN KEY (`fk_id_venta`) REFERENCES `ventas` (`id_venta`) ON DELETE CASCADE ON UPDATE NO ACTION
...
(8,'playera v1','Playera color morado',5493.230,8,'./images/peso1.JPG');
